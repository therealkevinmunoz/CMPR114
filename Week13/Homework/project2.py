...
class TestAvg:
    def __init__(self):
        ...
        self.avg_result_label = tkinter.Label(self.avg_frame, text='Average: ')
        ...
        self.sum_result_label = tkinter.Label(self.sum_frame, text='Sum: ')
        self.sum = tkinter.StringVar()
        self.sum_label = tkinter.Label(self.sum_frame, textvariable=self.sum)
        self.sum_result_label.pack(side='left')
    ...
    def calc_sum(self):
        ...
        self.sum_calc = self.test1 + self.test2 + self.test3 + self.test4 + self.test5

        self.sum.set(self.sum_calc)
